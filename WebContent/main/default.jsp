...
<body>
	<div align="center">
		<div id="amazingslider-wrapper-1" style="display:block;position:relative;max-width:640px;margin:0px auto 56px;">
	        <div id="amazingslider-1" style="display:block;position:relative;margin:0 auto;">
	            ...
	            <ul class="amazingslider-thumbnails" style="display:none;">
	                <li><img src="images/7SlILk2WMTI-tn.png" alt="Marvel&apos;s Captain America: The Winter Soldier" title="Marvel&apos;s Captain America: The Winter Soldier" /></li>
	                <li><img src="images/pWdKf3MneyI-tn.png" alt="Marvel&apos;s Ant-Man" title="Marvel&apos;s Ant-Man" /></li>
	                <li><img src="images/HSzx-zryEgM-tn.png" alt="Marvel&apos;s Doctor Strange" title="Marvel&apos;s Doctor Strange" /></li>
	                <li><img src="images/dKrVegVI0Us-tn.png" alt="Marvel&apos;s Captain America: Civil War" title="Marvel&apos;s Captain America: Civil War" /></li>
	                <li><img src="images/JAUoeqvedMo-tn.png" alt="Marvel&apos;s Avengers: Age of Ultron" title="Marvel&apos;s Avengers: Age of Ultron" /></li>
	            </ul>
